...
- `左摇杆`控制x,y。 左右居中数值在127，最左是0， 最右255； 上下居中数值是127， 最下是255，最上是0
- `L3+左摇杆`控制z。左右居中数值在127，最左是0， 最右255(左右不使用)； 上下居中数值是127， 最下是255，最上是0
- `右摇杆`控制roll,pitch。 左右居中数值在127，最左是0， 最右255； 上下居中数值是127， 最下是255，最上是0
- `L3+右摇杆`控制yaw。左右居中数值在127，最左是0， 最右255(左右不使用)； 上下居中数值是127， 最下是255，最上是0
- R2控制夹爪。 R2的模拟值默认是0，按到底是255